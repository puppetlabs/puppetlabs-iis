...
group :development do
  ...
  gem 'json_pure',                          :require => false if Gem::Version.new(RUBY_VERSION) >= Gem::Version.new('2.0.0')
end
...
puppet_less_than_35 = ENV['PUPPET_GEM_VERSION'] && Gem::Version.correct?(ENV['PUPPET_GEM_VERSION']) && Gem::Requirement.new('< 3.5.0').satisfied_by?(Gem::Version.new(ENV['PUPPET_GEM_VERSION']))
if puppet_gem_location != :gem || puppet_less_than_35
