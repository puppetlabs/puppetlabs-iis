...
Puppet::Type.type(:iis_mimetype).provide(:iis_mimetype) do
	...
	def self.get_mimetypes
		output = powershell("Get-WebConfiguration -Recurse -Filter /system.webServer/staticContent/mimeMap | select fileExtension,mimeType,Location,PSPath | ConvertTo-Json")
